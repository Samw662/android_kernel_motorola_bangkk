...
#define register_panel_notifier(...) msm_drm_register_client(&touch_cdev->panel_nb)
#define unregister_panel_notifier(...) msm_drm_unregister_client(&touch_cdev->panel_nb)
